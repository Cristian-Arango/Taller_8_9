...
CREATE TABLE `product_tbl` (
  ...
  CONSTRAINT `category_id` FOREIGN KEY (`category_id`) REFERENCES `category_tbl` (`category_id`)
...
INSERT INTO `product_tbl` VALUES (1,'CR7',12500,2),(2,'ZANAHORIA',2500,6),(3,'FUTBOL',2500,7);
